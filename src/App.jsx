...
const DISTRICTS = {
  rda: {
    ...
    law: (
      <>
        <a
          href="https://law.justia.com/codes/california/2011/code-hsc/division-24/part-1/"
          target="_blank"
  ...
  ifd: {
    ...
    label: "IFD",
    summary:
      "A narrower parallel TIF tool created in 1990 for infrastructure — still active today.",
...
const CRD_DRD_ROWS = [
  ...
  { feature: "Eligible Spending — Climate", crd: "✓ Sea level rise, heat, wildfire, drought, flood, cold", drd: "✓ All CRD climate projects (inherited)" },
  { feature: "Eligible Spending — Rebuilding", crd: "✗ Cannot fund repair/replacement of damaged structures", drd: "✓ Acquiring, demolishing, repairing disaster-damaged structures" },
  { feature: "Eligible Spending — Housing", crd: "✗ Not explicitly included", drd: "✓ Low- and moderate-income housing damaged by disaster" },
  { feature: "Eligible Spending — Utilities", crd: "✗ Not explicitly included", drd: "✓ Undergrounding and hardening electrical lines and utilities" },
  { feature: "Eligible Spending — Economic Recovery", crd: "✗ Not included", drd: "✓ Supporting economic recovery from the disaster" },
...
<p style={{ fontSize: 13, color: T.sub, margin: 0 }}>
    ...
    Click on a district below to see its history and powers.
  </p>
