...
function BranchingTimeline({ onSelectDistrict }) {
  ...
  const nodes = [
    { id: "rda",  x: 90,  y: 55,  r: 28, label: "RDA",  sub: "1945", note: "first-generation TIF" },
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              {d.death && (
                <div style={{ background: "#fef2f2", border: "1px solid #fecaca", borderRadius: 7, padding: "10px 12px", marginTop: 12 }}>
                  <div style={{ fontSize: 8.5, color: "#dc2626", textTransform: "uppercase", letterSpacing: 1, marginBottom: 5 }}>{d.id === "ifd" ? "Why It Was Superseded" : "Why It Went Extinct"}</div>
